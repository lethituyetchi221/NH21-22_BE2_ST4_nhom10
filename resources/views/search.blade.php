                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <div class="filter__found">
                                    <h6><span>{{count($search)}}</span> Products found</h6>
                                </div>
                            </div>
                            ...
                            <div class="product__item">
                                <div class="product__item__pic set-bg" data-setbg="{{asset('img/product/'.$item->image)}}">
                                    <ul class="product__item__pic__hover">
                                        <li><a href="{{route('addWishlist',['id'=>$item->id])}}"><i class="fa fa-heart" <?php if (Auth::check() && count(Wishlist::where('user_id',Auth::user()->id)->where('product_id',$item->id)->get())) {
                                            echo 'style="color: red"';
                                        } ?>></i></a></li>
                                        <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        <li><a href="{{ route('addCartGet', ['id' => $item->id]) }}"><i class="fa fa-shopping-cart"></i></a></li>
                                    </ul>
                                </div>
