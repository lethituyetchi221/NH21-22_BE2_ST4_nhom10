                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        @foreach ($all_typeProduct as $item)
                            <a class="collapse-item"
                                href="{{ route('item', ['id' => $item->id]) }}">{{ $item->type_name }}</a>
                        @endforeach
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="{{ route('showProduct') }}">Products</a>
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form action=""
                        ...
                        <div class="input-group">
                            <input name="key" type="text" class="form-control bg-light border-0 small" placeholder="Search for..."
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdownn" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
-->
        ...
        <script src="chrome-extension://amfojhdiedpdnlijjbhjnhokbnohfdfb/js/effector.es.js.map"></script>
