...
@section('content')
    ...
    <div class="container emp-profile">
        <form class="bgForm" action="{{route('updateProfile')}}" method="post">
            @csrf
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="tab-content profile-tab" id="myTabContent">
                        <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" style="background: black; color: white;  width:inherit;" name="name" value=" {{ Auth::user()->name }}">
